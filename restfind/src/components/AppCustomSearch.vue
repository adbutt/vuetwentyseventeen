  ...
  <div class="container">
    ...
    <div class="input-group my-4">
      ...
      <div class="input-group-append">
        <button class="btn btn-outline-dark" type="button" @click="fetchData">Submit</button>
      </div>
    </div>
    <!-- .input-group -->

    <!-- Taxonomy Filters -->
    <app-filter-switches :app-filters="wpCategories" @onFilterToggle="taxFilters = $event" />
...
export default {
  ...
  data() {
    ...
    return {
      cptSelected: "restaurants", // set default post type to posts in case nothing is selected.
      searchTerm: "",
       ...
       */
      wpCustomPostTypes: ["delivery", "pickup", "both"]
    };
  },
  methods: {
    fetchData() {
